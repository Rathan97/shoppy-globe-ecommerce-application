...
function ProductDetails() {
  ...
  return (
    <div className="bg-white min-h-screen pt-20 p-3">
      <div className="container mx-auto px-4 py-8">
        <div className="flex flex-wrap -mx-4">
          ...
          <div className="w-full md:w-1/2 px-4 md:mt-8">
            ...
            <p className="text-gray-600 text-sm sm:text-base  mb-4 capitalize">
              Category: {category}
            </p>
            ...
            {/* Extra Info: Warranty, Shipping, Availability, Return Policy */}
            ...
            <div className="flex space-x-4 my-6">
              <button
                ...
                className="bg-yellow-400 flex gap-2 items-center text-black font-medium px-6 py-2 rounded-md hover:bg-yellow-500 focus:outline-none focus:ring-2 focus:ring-yellow-500 focus:ring-offset-2"
              >
      ...
      {/* Reviews Section */}
      <div className="mt-10  ">
        <h3 className="text-xl sm:text-2xl  font-bold mb-10 text-center">
          Customer Reviews
        </h3>
        {reviews.length === 0 && (
        ...
        <div className="space-y-4 mb-20">
          {reviews.map((rev, idx) => (
            <div
              key={idx}
              className="flex items-start space-x-4 ml-5 sm:ml-10  "
            >
              {/* Reviewer Icon */}
              ...
              <div className="flex-1">
                <p className="flex items-baseline text-[12px] sm:text-base ">
                  ...
                  <span className="ml-2 text-gray-500 text-[10px]  sm:text-sm">
                    Verified Buyer
                  </span>
                </p>
                ...
                <p className="mt-2 text-[11px] sm:text-sm text-gray-700">
                  {rev.comment}
                </p>
