...
function Cart() {
  ...
  const shipping = productsCart.length > 0 ? 2 : 0;
  ...
  return (
    <div className="max-w-5xl max-lg:max-w-2xl mx-auto bg-white px-4 pt-25 pb-12 mb-10 min-h-screen">
      ...
      {/* Main Grid Layout: Cart Items + Order Summary */}
        ...
        <div className="bg-gray-100 rounded-md p-4 h-max">
          ...
          <div className="mt-8 space-y-3">
            <button
              ...
              className="text-sm px-4 py-2.5 w-full font-medium tracking-wide bg-blue-700 hover:bg-blue-600 text-white rounded-md"
