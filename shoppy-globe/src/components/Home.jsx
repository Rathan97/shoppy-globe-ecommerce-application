  ...
  return (
    <div>
      ...
      <section className="bg-white w-full h-screen pt-20 lg:pt-0 lg:grid lg:place-content-center">
        <div className="mx-auto w-full max-w-screen-xl px-4 py-8 sm:px-6 sm:py-0 md:grid md:grid-cols-2 md:items-center md:gap-6 lg:px-8 lg:py-10">
      ...
      >
        ...
        <div
          ...
          "
        >
          {/* Rendering Each Product Item from Dummy Data */}
