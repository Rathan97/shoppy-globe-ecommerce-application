...
//This file is used to store the data into the database, just run this file before running the application.
...
// Create the product model based on the schema
  ...
  const result =  products.insertMany(productsData);

  result.then((data)=> console.log("data saved successfully")).catch((e)=> console.log("error", e));
